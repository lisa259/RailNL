...
while len(list_with_trajects) < MAX_AANTAL_TREINEN:
    ...
    if len(list_with_trajects)==0:
         i = 27
         traject = TRAJECT()
         traject.addStation(list_with_connections[i].station1, "begin")
         traject.addStation(list_with_connections[i].station2, "end")
         traject.addTotal_time(list_with_connections[i].duration)
         list_with_connections[i].setUsed(True)
         #print("beginstation1 is: " + list_with_connections[3].station1)
         #print("beginstation2 is: " + list_with_connections[3].station2)
         print(traject.stations)
         list_with_trajects.append(traject)
    else:
        print("hier")
        new = new_traject()
        if new != False:
...
print(aantal)
print(doelfunctie())
#print(list_with_trajects[0].stations)
#print(list_with_trajects[1].stations)
