...
naam_connecties = os.path.join(os.path.dirname(__file__), 'csv', 'ConnectiesHolland.csv')
...
name_stations = os.path.join(os.path.dirname(__file__), 'csv', 'StationsHolland.csv')
